import { JSBI, Token } from '@oikos/swap-sdk'
...
export default function MigrateV1() {
  ...
  // should never always be false, because a V1 exhchange exists for WTRX on all testnets
    ...
    <BodyWrapper style={{ padding: 24 }}>
      <AutoColumn gap="16px">
        ...
        <TYPE.body style={{ marginBottom: 8, fontWeight: 400 }}>
          For each pool shown below, click migrate to remove your liquidity from Swap V1 and deposit it into Swap
          V2.
        </TYPE.body>
